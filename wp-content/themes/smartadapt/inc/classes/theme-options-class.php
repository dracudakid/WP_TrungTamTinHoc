...
class smartadapt_Customize
{
    ...
    public static $pro_link = 'https://creativemarket.com/netbiel/312170-SmartAdapt-Pro-Clean-Responsive';
     ...
     * @return string
     */
    public function sanitize_breadcrumb_separator($value)
    {
        if (strlen($value) == 0) {
    ...
    public function sanitize_project_layout($value)
    {
    ...
    public function sanitize_pagination_posts($value)
    {
    ...
    public function sanitize_project_layout_width($value)
    {
        $value = (int)$value;
...
if (class_exists('WP_Customize_Control')) {
    class smartadapt_Customize_Range_Control extends WP_Customize_Control
    {
        ...
        <fieldset class="range-fieldset">
            <label for="<?php echo $this->id ?>">
                <?php echo esc_html($this->label); ?></label>
            <input type="text" class="slider-range-input" readonly="readonly" id="<?php echo $this->id ?>"
                   class="range-customize-input" <?php $this->link(); ?>
                   value="<?php echo esc_textarea($this->value()); ?>"/><span>px</span>
    ...
    class smartadapt_Customize_RangeReadonly_Control extends WP_Customize_Control
    {
        ...
        <div class="smartadapt-form-proversion-info-outer">
            <div class="smartadapt-form-proversion-info-inner"><a href="<?php echo self::$pro_link ?>" target="_blank"
                                                                  class="smartadapt-proversion-link"><?php _e('Available in pro version &#187;', 'smartadapt');?> </a>
            </div>
    ...
    class smartadapt_Customize_Layout_Control extends WP_Customize_Control
    {
        ...
        {
            ?>
        <li id="customize-control-smartadapt_theme_options_smartadapt_layout"
            class="customize-control customize-control-radio">
            <div class="smartadapt-form-proversion-info-outer">
                <div class="smartadapt-form-proversion-info-inner"><a href="<?php echo self::$pro_link ?>"
                                                                      target="_blank"
                                                                      class="smartadapt-proversion-link"><?php _e('Available in pro version &#187;', 'smartadapt');?></a>
                </div>
                <span class="customize-control-title"><?php _e('Layout variants:', 'smartadapt'); ?></span>
                <label>
                    <input type="radio" value="1" name="_customize-radio-smartadapt_theme_options_smartadapt_layout"
                           data-customize-setting-link="smartadapt_theme_options[smartadapt_layout]" checked="checked">
                    <?php _e('Left menu &amp; right sidebar', 'smartadapt'); ?><br>
                </label>
                <label>
                    <input type="radio" value="2" name="_customize-radio-smartadapt_theme_options_smartadapt_layout"
                           data-customize-setting-link="smartadapt_theme_options[smartadapt_layout]">
                    <?php _e('Left sidebar &amp; right menu', 'smartadapt');?><br>
                </label>
                <label>
                    <input type="radio" value="3" name="_customize-radio-smartadapt_theme_options_smartadapt_layout"
                           data-customize-setting-link="smartadapt_theme_options[smartadapt_layout]">
                    <?php _e('Right sidebar without menu', 'smartadapt');?><br>
                </label>
                <label>
                    <input type="radio" value="4" name="_customize-radio-smartadapt_theme_options_smartadapt_layout"
                           data-customize-setting-link="smartadapt_theme_options[smartadapt_layout]">
...
$customizer = new smartadapt_Customize();
