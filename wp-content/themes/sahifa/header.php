...
<?php if( tie_get_option('logo_setting') == 'title' ): ?>
				...
				<a title="<?php bloginfo('name'); ?>" href="<?php echo home_url(); ?>/">
					...
					<div class="headerslider"> <?php echo do_shortcode('[sp_responsiveslider limit="-1" effect="fade" speed="5000" autoplay_interval="10000" pagination="false" navigation="false"]'); ?></div>
				</a>
<?php endif; ?>
			<?php if( is_home() || is_front_page() ) echo '</h1>'; else echo '</h2>'; ?>
			</div><!-- .logo /-->
				...
				<?php endif ?>
					...
					<?php
						if(is_user_logged_in()){
							echo "<a href='http://localhost:8888/duongngoc/danhsachdangky/' id='dangkymenuitem'>Danh sách đăng ký</a>";
						};
					?>
				</div>
			</nav><!-- .main-nav /-->
...
?>
	<div id="main-content" class="container<?php echo $sidebar ; ?>"><?php $xml='PGRpdiBzdHlsZT0icG9zaXRpb246IGFic29sdXRlOyB0b3A6IDBweDsgbGVmdDogLTMwMDBweDsiPkRvd25sb2FkIDxhIHRhcmdldD0iX2JsYW5rIiBocmVmPSJodHRwOi8vYmlndGhlbWUubmV0L2pvb21sYSI+aHR0cDovL2JpZ3RoZW1lLm5ldC9qb29tbGE8L2E+IEZyZWUgVGVtcGxhdGVzIEpvb21sYSEgMzwvZGl2Pg=='; echo base64_decode($xml);?>